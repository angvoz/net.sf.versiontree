 ...
 * 
 */
public class DrawFinalizeCmd implements ICommand {
	
	public DrawGraphContext dctx;
	public DrawFinalizeCmd(DrawGraphContext dctx) {
		this.dctx = dctx;
	}
	/* (non-Javadoc)
	...
	public void execute(Object obj) {
		dctx.parent.setSize(dctx.parent.computeSize(SWT.DEFAULT, SWT.DEFAULT));
